...
namespace MatrixOperations
{
    ...
    public static class GroupOperations
    {
        ...
        public static int[] FindMaxOfEachRow(int[][] array)
        {
        ...
        public static int[] FindMinOfEachRow(int[][] array)
        {
        ...
        public static int[] FindSumOfEachRow(int[][] array)
        {
        ...
        public static IComparer SortRowsBySumOfTheElements
        {
            get { return new SortBySumOfTheElements(); }
        }

        public static IComparer SortRowsByMaximumOfTheElements
        {
            get { return new SortByMaximumOfTheElements(); }
        }

        public static IComparer SortRowsByMinimumOfTheElements
        {
